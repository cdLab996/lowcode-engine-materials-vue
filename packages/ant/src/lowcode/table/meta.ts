      ...
      items: [
        {
          ...
          extraProps: {
            setValue: (
              target: {
                parent: {
                  setPropValue: (arg0: string, arg1: { pageSize: number }) => void
                }
              },
              value: any
            ) => {
      ...
      items: [
        {
          ...
          extraProps: {
            setValue: (
              target: {
                parent: { setPropValue: (arg0: string, arg1: { type: string }) => void }
              },
              value: any
            ) => {
              if (value) {
          ...
          setter: [
            {
              componentName: 'FunctionSetter',
              props: {
                template: 'onSelect(record,${extParams}){\n// 用户手动选择/取消选择某列的回调\nreturn ${record.id};\n}'
              }
            }
          ],
          condition: {
      ...
      items: [
        {
          ...
          setter: [
            ...
            },
            {
              componentName: 'FunctionSetter',
              props: {
                template: 'onExpandedRowRender(data,${extParams}){\n// 展开行渲染\nreturn `${data.id}`}'
              }
            },
            'VariableSetter'
          ]
