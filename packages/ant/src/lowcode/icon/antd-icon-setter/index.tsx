    ...
    <div className='lc-antd-icon-setter'>
      ...
      >
        <div className='lc-antd-icon-setter-header'>
          ...
          <Search className='lc-antd-icon-setter-header-search' size='medium' shape='simple' onChange={setSearch} />
        </div>
        <div className='lc-antd-icon-setter-content'>
          <ul className='lc-antd-icon-setter-list'>
            {list.map((item) => (
              <li key={item.name} className='lc-antd-icon-setter-list-item' onClick={() => handleChange(item.name)}>
